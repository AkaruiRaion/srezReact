            ...
            <div className={s.sort__category}>
                <div className={s.cat}>
                    ...
                    <div className={s.btns}>
                        ...
                        <buttton onClick={() => setCategory(1)} className='btn'>Худи</buttton>
                        <buttton onClick={() => setCategory(2)} className='btn'>Толстовки</buttton>
                        <buttton onClick={() => setCategory(3)} className='btn'>Зипки</buttton>
                    </div>
                </div>
            ...
            <div className={s.cards}>
                {
                    sortedFilteredProducts.length ?
                        sortedFilteredProducts.map((product) => {
                            return (
                                <Card id={product.id} img={product.img} name={product.name} price={product.price} count={product.count} size={product.size} />
                            )
                        })
                        :
